...
" Keywords
syntax keyword bleKeyword include as and or not if then elif else for to step each in while do fn mut builtin disp input getch kbhit rand int float str type true false none argv class read write readb writeb cls time cli os
