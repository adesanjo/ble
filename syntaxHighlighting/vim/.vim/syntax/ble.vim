...
" Keywords
syntax keyword bleKeyword true false none module argv class include as and or not if then elif else for to step each in while do fn mut builtin return disp input getch kbhit rand int float str type read readb write writeb cls time cli os
